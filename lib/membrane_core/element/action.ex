defmodule Membrane.Element.Action do
  ...
  @type demand_filter_payload_t :: {Pad.name_t, {:source, Pad.name_t} | :self, size :: non_neg_integer}
  ...
  @type demand_t :: {:demand, demand_common_payload_t | demand_filter_payload_t | demand_sink_payload_t}
  ...
  actions available.
  """
  @type t :: event_t | message_t | split_t | caps_t | buffer_t | demand_t | redemand_t | forward_t | playback_change_t
