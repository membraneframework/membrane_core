defmodule Membrane.Testing.Pipeline do
  ...
  with it's elements. It also provides utility for receiving messages when
  ...
  and pass to `Membrane.Testing.Pipeline.start_link/2`.
  ...
  We can now wait till end of stream reaches the sink element.
