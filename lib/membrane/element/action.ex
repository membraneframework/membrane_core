defmodule Membrane.Element.Action do
  ...
  `c:Membrane.WithInputPads.handle_buffer_list/4` uses split action to invoke
  ...
  `c:Membrane.WithInputPads.handle_buffer_list/4` callback. Invoked callback is
  ...
  - element is filter,
  - callback is `c:Membrane.WithInputPads.handle_buffer_list/4`,
  `c:Membrane.Element.WithInputPads.handle_stream_format/4`
  or `c:Membrane.Element.Base.handle_event/4`,
  - playback is `playing`

  Keep in mind that `c:Membrane.WithInputPads.handle_buffer_list/4` can only
