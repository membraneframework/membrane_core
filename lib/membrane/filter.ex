defmodule Membrane.Filter do
  ...
  new_docstring =
    docstring <>
      ...
      #{Membrane.DocsHelper.generate_docstring_with_list_of_callbacks(__MODULE__, [Membrane.Element.Base, Membrane.Element.WithInputPads, Membrane.Element.WithOutputPads])}
      """
