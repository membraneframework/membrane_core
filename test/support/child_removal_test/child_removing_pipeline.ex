defmodule Membrane.Support.ChildRemovalTest.ChildRemovingPipeline do
  ...
  def handle_init(_ctx, _opts) do
    ...
    spec2 = {structure2, group: :first_crash_group, crash_group_mode: :temporary}

    structure3 = [get_child(:source) |> via_out(:third) |> child(:filter3, FilterToBeRemoved)]
    spec3 = {structure3, group: :first_crash_group, crash_group_mode: :temporary}
    ...
    spec4 = {structure4, group: :second_crash_group, crash_group_mode: :temporary}
