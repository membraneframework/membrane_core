defmodule Membrane.Integration.AutoDemandsTest do
  ...
  defmodule AutoDemandFilter do
    ...
    def_output_pad :output, caps_pattern: _any, demand_mode: :auto
  ...
  defmodule AutoDemandTee do
    ...
    def_input_pad :input, caps_pattern: _any, demand_mode: :auto
    def_output_pad :output, caps_pattern: _any, demand_mode: :auto, availability: :on_request
  ...
  defmodule PushSource do
    ...
    def_output_pad :output, mode: :push, caps_pattern: _any
