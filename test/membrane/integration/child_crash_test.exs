defmodule Membrane.Integration.ChildCrashTest do
  ...
  test "Element that is not member of any crash group crashed when pipeline is in playing state" do
    ...
    [sink_pid, center_filter_pid, filter_1_1_pid, filter_2_1_pid, source_1_pid] =
      [
        :sink,
        :center_filter,
        {:__membrane_child_group_member__, 1, :filter_1_1},
        {:__membrane_child_group_member__, 1, :filter_2_1},
        {:__membrane_child_group_member__, 1, :source_1}
      ]
  ...
  test "small pipeline with one crash group test" do
    ...
    [source_pid, center_filter_pid, sink_pid] =
      [{:__membrane_child_group_member__, 1, :source}, :center_filter, :sink]
      |> Enum.map(&get_pid_and_link(&1, pipeline_pid))
  ...
  test "Crash group consisting of bin crashes" do
    ...
    [
      ...
      [
        :sink,
        :center_filter,
        {:__membrane_child_group_member__, 1, :bin_1},
        {:__membrane_child_group_member__, 2, :bin_2},
        {:__membrane_child_group_member__, 3, :bin_3},
        {:__membrane_child_group_member__, 1, :source_1},
        {:__membrane_child_group_member__, 2, :source_2},
        {:__membrane_child_group_member__, 3, :source_3}
      ]
      |> Enum.map(&get_pid_and_link(&1, pipeline_pid))
  ...
  test "Crash two groups one after another" do
    ...
    [
      ...
      [
        ...
        {:__membrane_child_group_member__, 1, :filter_2_1},
        {:__membrane_child_group_member__, 1, :source_1},
        {:__membrane_child_group_member__, 2, :filter_1_2},
        {:__membrane_child_group_member__, 2, :filter_2_2},
        {:__membrane_child_group_member__, 2, :source_2}
      ]
      |> Enum.map(&get_pid_and_link(&1, pipeline_pid))
