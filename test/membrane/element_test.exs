defmodule Membrane.ElementTest do
  ...
  test "play", %{pipeline: _pipeline} do
    TestFilter.assert_callback_called(:handle_playing)
  end

  describe "Start of stream" do
    test "causes handle_start_of_stream/3 to be called", %{pipeline: _pipeline} do
      TestFilter.assert_callback_called(:handle_start_of_stream)
    end

    test "does not trigger calling callback handle_event/3", %{pipeline: _pipeline} do
  ...
  describe "End of stream" do
    test "causes handle_end_of_stream/3 to be called", %{pipeline: _pipeline} do
