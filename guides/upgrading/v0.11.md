...
To update callbacks:
___
Rename `handle_other/3` into `handle_info/3`
...
Add an implementation of the Membrane.Bin.handle_parent_notification/3 and Membrane.Element.handle_parent_notification/3 in place of the Membrane.Bin.handle_info/3 and Membrane.Element.handle_info/3 (former `handle_info/3` callbacks) that were responsible for receiving messages from the parents.
```diff
