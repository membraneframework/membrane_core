...
To update callbacks
  ...
  * add an implementation of the `Membrane.Bin.handle_parent_notification/3` and `Membrane.Element.handle_parent_notification/3` in place of the `Membrane.Bin.handle_other/3` and `Membrane.Element.handle_other/3` that
