...
## 1.0.0
 * Replace `Membrane.Time.round_to_<unit_name>/1` with `Membrane.Time.as_<unit_name>/2` with second argument equal `:round`.
 * Rename `Membrane.Time.round_to_timebase/2` to `Membrane.Time.divide_by_timebase/2`.
